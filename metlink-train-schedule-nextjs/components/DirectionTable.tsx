...
import { getImportantNotices } from '@/lib/utils/departureUtils';
import { MAX_DEPARTURES } from '@/lib/constants';
...
export function DirectionTable({ departures, title, description }: DirectionTableProps) {
  ...
  const notices = useMemo(() => {
    const allNotices = displayedDepartures
      ...
      .filter((notice): notice is string => notice !== null && notice.trim().length > 0)
